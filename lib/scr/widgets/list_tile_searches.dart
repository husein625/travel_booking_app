...
class ListTileSearches extends StatefulWidget {
  @override
  _ListTileSearchsState createState() => _ListTileSearchsState();
}

class _ListTileSearchsState extends State<ListTileSearches> {
  List<Place> places = [
